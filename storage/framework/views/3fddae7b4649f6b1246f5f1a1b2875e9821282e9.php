            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4" style="padding-left:0px;">
                        <div class="thumbnail">
                            <img src="http://ecommerceforest.com/wrap/shoppe-stores-v2.6.5/demos/sports/images/banners/3col-banner1.jpg" alt="" style="height: 170px;">
                            <div class="caption">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4" style="padding-left:0px;">
                        <div class="thumbnail">
                            <img src="http://ecommerceforest.com/wrap/shoppe-stores-v2.6.5/demos/sports/images/product-images/1.jpg" alt="" style="height: 170px;">
                            <div class="caption">
                                <h4 class="pull-right">$24.99</h4>
                                <h4><a href="#">First Product</a>
                                </h4>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4" style="padding-left:0px;">
                        <div class="thumbnail">
                            <img src="http://ecommerceforest.com/wrap/shoppe-stores-v2.6.5/demos/sports/images/product-images/4.jpg" alt="" style="height: 170px;">
                            <div class="caption">
                                <h4 class="pull-right">$24.99</h4>
                                <h4><a href="#">First Product</a>
                                </h4>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4" style="padding-left:0px;">
                        <div class="thumbnail">
                            <img src="http://ecommerceforest.com/wrap/shoppe-stores-v2.6.5/demos/sports/images/banners/3col-banner2.jpg" alt="" style="height: 170px;">
                            <div class="caption">
                                <h4 class="pull-right">$24.99</h4>
                                <h4><a href="#">First Product</a>
                                </h4>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4" style="padding-left:0px;">
                        <div class="thumbnail">
                            <img src="http://the7smalldemos.dreamthemecom.netdna-cdn.com/shop/wp-content/uploads/sites/7/2014/09/h8-f-700x850.jpg" alt="" style="height: 170px;">
                            <div class="caption">
                                <h4 class="pull-right">$24.99</h4>
                                <h4><a href="#">First Product</a>
                                </h4>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <div class="shopbest">
                                        ...
                                        <p class="dt-shopbest">short thumbnail description</p>
                                        <p class="dt-shopbest"><a href="" class="label label-danger">Details</a>
                                            <a href="" class="label label-success">Buy Now!</a></p>
                                    </div>
                                    <img src="http://lorempixel.com/400/300/sports/1/" alt="..." style="height: 130px;">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <img src="http://lorempixel.com/400/300/sports/2/" alt="..." style="height: 130px;">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <img src="http://lorempixel.com/400/300/sports/3/" alt="..." style="height: 130px;">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <img src="http://ecommerceforest.com/wrap/shoppe-stores-v2.6.5/demos/sports/images/product-images/3.jpg" alt="..." style="height: 130px;">
                                </div>
                            </div>
                        </div>
