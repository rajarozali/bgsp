    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                ...
                <article>
                    <div class="col-md-12 no-padding">
                        <a href="#">
                            <img src="http://the7smalldemos.dreamthemecom.netdna-cdn.com/news/wp-content/uploads/sites/5/2014/03/3x2-055-1000x1000.jpg" alt="" width="360" height="270">
                        </a>
                    </div>

                    <div class="col-md-12 no-padding">
                        <h3 class="entry-title">
                            <a href="show-news.html">Corporate identity: core design principles</a>
                        </h3>

                        <p style="text-align: justify;">Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur. Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur?</p>
                        <a href="#" class="details more-link">Details >></a>
                        <div class="entry-meta">
                            <a href="#" class="fancy-date">
                                <span class="entry-month">Mar</span>
                                <span class="entry-date updated">18</span>
                                <span class="entry-year">2014</span>
                            </a>
                            <span> / </span>
                            <a href="#" class="comment-link">3 Comments</a>
                            <span> / </span>
                            <a class="author" href="#" rel="author">By <span class="fn">Admin</span></a>
                        </div>
                        <div>
                            <ul class="tags tagnews">
            ...
            <div class="col-md-5">
                ...
                <article class="recent-news col-md-12 no-padding">
                    <div class="col-md-4 no-padding">
                        <a href="#">
                            <img style="width: 90%;" src="http://static.livedemo00.template-help.com/wt_58731/images/index-11.jpg" alt="">
                        </a>
                    </div>
                    <div class="col-md-8 no-padding">
                        <h4><a href="#">Add yoga classes to your everyday life</a></h4>
                        <time class="text-secondary" datetime="2014-03-18T13:25:56+00:00">18/03/2014</time>
                        <ul class="tags tagnews">
                            <li><a href="#">Design &amp; Photography</a></li>
                            <li><a href="#">World News</a></li>
                            <li><a href="#">Bitcoin</a></li>
                ...
                <article class="recent-news col-md-12 no-padding">
                    <div class="col-md-4 no-padding">
                        <a href="#">
                            <img style="width: 90%;" src="http://static.livedemo00.template-help.com/wt_58731/images/index-14.jpg" alt="">
                        </a>
                    </div>
                    <div class="col-md-8 no-padding">
                        <h4><a href="#">Add yoga classes to your everyday life</a></h4>
                ...
                <article class="recent-news col-md-12 no-padding">
                    <div class="col-md-4 no-padding">
                        <a href="#">
                            <img style="width: 90%;" src="http://static.livedemo00.template-help.com/wt_58731/images/index-19.jpg" alt="">
                        </a>
                    </div>
                    <div class="col-md-8 no-padding">
                        <h4><a href="#">Add yoga classes to your everyday life life</a></h4>
                        <time class="text-secondary" datetime="2014-03-18T13:25:56+00:00">18/03/2014</time>
                        <ul class="tags tagnews">
                            <li><a href="#">Bitcoin</a></li>
                        </ul>
                ...
                <article class="recent-news col-md-12 no-padding">
                    <div class="col-md-4 no-padding">
                        <a href="#">
                            <img style="width: 90%;" src="http://static.livedemo00.template-help.com/wt_58731/images/index-22.jpg" alt="">
                        </a>
                    </div>
                    <div class="col-md-8 no-padding">
                        <h4><a href="#">Add yoga classes to your everyday life</a></h4>
                ...
                <article class="recent-news col-md-12 no-padding">
                    <div class="col-md-4 no-padding">
                        <a href="#">
                            <img style="width: 90%;" src="http://static.livedemo00.template-help.com/wt_58731/images/index-25.jpg" alt="">
                        </a>
                    </div>
                    <div class="col-md-8 no-padding">
                        <h4><a href="#">Add yoga classes to your everyday life</a></h4>
                ...
                <br>
                <div class="col-md-12">
                    <h4><a href="#" class="more more-link">More >></a><h4>
                </div>
