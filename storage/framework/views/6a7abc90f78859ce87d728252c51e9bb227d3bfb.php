<div class="col-md-12" id="ajax_div" ng-app="builderApp" ng-controller="querybuilder" ng-cloak>
    ...
    <uib-tabset active="active" template-url="../assets/vendors/ui-bootstrap/tpl/panel-with-nav-tab-tabset.html">
            ...
            <div class="res-table">
                <table class="table table-striped table-hover table-fixed ellipsis-table" >
                    ...
                    <tr>
                        ...
                        <th width="55%"><?php echo e(trans('main.description')); ?></th>
                        <th width="5%">
        ...
        <uib-tab index="1" ng-show="showTab2" template-url="../assets/vendors/ui-bootstrap/tpl/panel-with-nav-tab-tab.html">
            ...
            <input type="hidden" name="id" id="id" value="<?php echo e(isset($editmodule['id']) ? $editmodule['id'] : ''); ?>">
                ...
                <uib-accordion close-others="false" template-url="../assets/vendors/ui-bootstrap/tpl/yep-accordian-tpl.html">
                    ...
                    <uib-accordion-group is-open="true" heading="1: Select columns to show" template-url="../assets/vendors/ui-bootstrap/tpl/accordian-panel.html">
                        <div class="col-md-6 layout no-padding">
                            ...
                            <br>
                            <?php /*<textarea style="width: 100%;">[[report.myFields]]</textarea>*/ ?>
                            ...
                            <ul ng-repeat="filter in report.filters">
                                ...
                                <li data-label="Reconciling">
                                    <select  ng-model="filter.reconcil" class="form-control"
                                             ...
                                             ng-show="!$first">
                                        <?php /*<option value="and" selected>AND</option>*/ ?>
                                        <?php /*<option value="or">OR</option>*/ ?>
                                    </select>
                    ...
                    <?php /*<uib-accordion-group  heading="4: Select Summery Type" template-url="../assets/vendors/ui-bootstrap/tpl/accordian-panel.html">*/ ?>
                        <?php /*<div class="col-md-6">*/ ?>
                            <?php /*<div class="yep-list" width="100%">*/ ?>
                                <?php /*<ul>*/ ?>
                                    <?php /*<li class="width-40">Column</li>*/ ?>
                                    <?php /*<li class="width-10">Count</li>*/ ?>
                                    <?php /*<li class="width-10">Sum</li>*/ ?>
                                    <?php /*<li class="width-10">Avg</li>*/ ?>
                                    <?php /*<li class="width-10">Max</li>*/ ?>
                                    <?php /*<li class="width-10">Min</li>*/ ?>
                                <?php /*</ul>*/ ?>
                                <?php /*<ul ng-repeat="field in fields | filter: countable">*/ ?>
                                    <?php /*<li>*/ ?>
                                        <?php /*[[field.field]]*/ ?>
                                    <?php /*</li>*/ ?>
                                    <?php /*<li>*/ ?>
                                        <?php /*<div class="checkbox checkbox-primary">*/ ?>
                                            <?php /*<input id="[[field.field]]" type="checkbox" class="conchkNumber">*/ ?>
                                            <?php /*<label for="[[field.field]]">*/ ?>
                                            <?php /*</label>*/ ?>
                                        <?php /*</div>*/ ?>
                                    <?php /*</li>*/ ?>
                                    <?php /*<li>*/ ?>
                            ...
                            <?php /*</div>*/ ?>
                        <?php /*</div>*/ ?>
                    <?php /*</uib-accordion-group>*/ ?>

                    <?php /*<uib-accordion-group  heading="4: Charts" template-url="../assets/vendors/ui-bootstrap/tpl/accordian-panel.html">*/ ?>
                        <?php /*<div class="col-md-6">*/ ?>
                            <?php /*<div class="form-horizontal">*/ ?>
                                <?php /*<div class="form-group">*/ ?>
                                    <?php /*<label class="col-md-3 control-label" for="textinput">Chart Type</label>*/ ?>
                                    <?php /*<div class="col-md-9">*/ ?>
                                        <?php /*<select ng-model="model1" class="form-control" ng-options="obj as obj.name for obj in chartType track by obj.id"></select>*/ ?>
                                    <?php /*</div>*/ ?>
                                <?php /*</div>*/ ?>
                                <?php /*<div class="form-group">*/ ?>
                                    <?php /*<label class="col-md-3 control-label" for="textinput">Sort by</label>*/ ?>
                                    <?php /*<div class="col-md-9">*/ ?>
                                        <?php /*<select ng-model="model1" class="form-control" ng-options="obj as obj.text for obj in list1 track by obj.id"></select>*/ ?>
                                    <?php /*</div>*/ ?>
                                <?php /*</div>*/ ?>
                            <?php /*</div>*/ ?>
                        <?php /*</div>*/ ?>
                        <?php /*<div class="col-md-6">*/ ?>
                            <?php /*<img src="../assets/img/chart/pie.png" alt="chart" class="img-responsive img-flat">*/ ?>
                        <?php /*</div>*/ ?>
                    <?php /*</uib-accordion-group>*/ ?>
                </uib-accordion>
